...
if($rname['student_author']==$_SESSION['username']){
?>
<form method="GET" action="updatecourse.php">
  ...
  <div class="borderBox">
    <div class="tabler">
      <?php if($rname['student_author']==$_SESSION['username']){ ?><a href="Detail.php?id=<?php echo $rname['id']; ?>" class="edit grayLG fright">แก้ไข</a><?php } ?>
    <table>
      <tbody>
      ...
      <tr>
        ...
        <?php echo $rname['id']; ?>
		<input type="hidden" name="id" value="<?php echo $rname['id']; ?>">
    ...
    ที่อยู่
        ...
        <td>
		  <?php echo $rname['subject']; ?>
				<input type="hidden" name="subject" value="<?php echo $rname['subject']; ?>">
        </td>
      </tr>
	      <tr>
        <td>
      ระดับชั้น
        ...
        <td>
				<input type="text" name="level" value="<?php echo $rname['level']; ?>">
     ...
     ที่อยู่
        ...
        <td>
				<input type="text" name="location" value="<?php echo $rname['location']; ?>">
       ...
       ราคา
        ...
        <td>
				<input type="text" name="rate" value="<?php echo $rname['rate']; ?> ">
        </td>
      </tr>
	  	      <tr>
        <td>
รายละเอียด
        ...
        <td>
				<input type="text" name="description" value=" <?php echo $rname['description']; ?>">
