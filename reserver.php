	...
	<body>
		...
		<div class="blog">
			<div class="destination-head">
				<div class="wrap">
			<?php 
$collreserve = $db->reserve;
$cursor2 = $collreserve->find(array('student_author' => $_SESSION['username'],'id' => $_GET['id']));
$sum2=$collreserve->count(array('student_author' => $_SESSION['username'],'id' => $_GET['id']));
if((int)$sum2==0){?>
<div class="wrapper">
  <div class="folderTab">
    <h3>วิชาที่ถูกจอง</h3>
...
$rname = array('id'=> $doc['id'],'reserver'=> $doc['reserver'],'student_author'=> $doc['student_author']) ;
?>
<tbody class="table-hover">
<tr>
<div id="outer">
<td class="text-center"><?php echo $rname['id']; ?></td>
<td class="text-center"><?php echo $rname['reserver']; ?></td>
<td class="text-center"><a href="checkremove.php?id=<?php echo $rname['id']; ?>&&username=<?php echo $rname['reserver']; ?>&&check=accept" class="button1">เลือกคนนี้</a><a href="checkremove.php?id=<?php echo $rname['id']; ?>&&username=<?php echo $rname['reserver']; ?>&&check=reject" class="button2">ไม่เอาคนนี้</a></td>
</div>
</tr>
