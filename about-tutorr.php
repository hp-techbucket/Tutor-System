...
?>
    ...
    บัญชีไลน์
     ...
     การศึกษา
        ...
        <td>
		<input type="text" name="education" value="<?php echo $users['education']; ?>">
        </td>
      </tr>
	      <tr>
        <td>
       ความสนใจ
        ...
        <td>
		<input type="text" name="interest" value="<?php echo $users['interest']; ?>">
        </td>
      </tr>
	  	      <tr>
        <td>
แนวการสอน
        ...
        <td>
		<input type="text" name="teaching_style" value="<?php echo $users['teaching_style']; ?>">
        </td>
      </tr>
	  	  			<?php 
}
