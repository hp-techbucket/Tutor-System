...
<header class="site-header" id="header">
		<h1 class="site-header__title" data-lead-id="site-header-title">เรียบร้อยแล้ว !</h1>
	</header>

	<div class="main-content">
		<i class="fa fa-check main-content__checkmark" id="checkmark"></i>
		<p class="main-content__body" data-lead-id="main-content-body">วิชาเรียนของคุณได้ถูกประกาศเรียบร้อยแล้ว ขอบคุณครับ.</p>
		<br>
				<a href="index.php" class="button1">กลับสู่หน้าหลัก</a>
	</div>
				<!---//End-criuse-grids----->
			</div>
		</div>
